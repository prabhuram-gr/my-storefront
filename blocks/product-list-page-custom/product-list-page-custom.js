...
export default async function decorate(block) {
  ...
  // plpRender.render($productList, ProductList, { storeDetails })
  // console.log(plpRender);
  console.log(ProductList);
  
  return await Promise.all([
    // plpApi.initialize(storeDetails),
    // provider.render(SearchBarInput, { storeDetails }, $input),
    // provider.render(ResultsInfo, { storeDetails }, $resultInfo,  ),
    // provider.render(Facets, $facets,  { storeDetails }),
